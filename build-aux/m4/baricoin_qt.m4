...
AC_DEFUN([BARICOIN_QT_FAIL],[
  if test "$baricoin_qt_want_version" = "auto" && test "$baricoin_qt_force" != "yes"; then
    if test "$baricoin_enable_qt" != "no"; then
...
AC_DEFUN([BARICOIN_QT_CHECK],[
  if test "$baricoin_enable_qt" != "no" && test "$baricoin_qt_want_version" != "no"; then
    true
    $1
  else
    true
...
AC_DEFUN([BARICOIN_QT_INIT],[
  ...
  AC_ARG_WITH([gui],
    ...
    [
     ...
     if test "$baricoin_qt_want_version" = "yes"; then
...
AC_DEFUN([BARICOIN_QT_CONFIGURE],[
  ...
  if test "$baricoin_cv_static_qt" = "yes"; then
  ...
  if test $baricoin_enable_qt = "yes"; then
