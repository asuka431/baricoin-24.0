...
Assumeutxo is a feature that allows fast bootstrapping of a validating baricoind
...
considered active. This is the "traditional" mode of operation for baricoind.
...
**Failure consideration:** if baricoind unexpectedly halts after `m_stop_use` is set on
...
### Baricoind restarts sometime after snapshot validation has completed

When baricoind initializes again, what began as the snapshot chainstate is now
