...
"""Example logging Baricoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/baricoind
...
def main(baricoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[baricoind_with_usdts])
