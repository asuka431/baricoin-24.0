...
class RawTransactionsTest(BaricoinTestFramework):
    ...
    def test_add_inputs_default_value(self):
        ...
        # Create and fund the wallet with 5 BARI
        ...
        # Fund wallet with 2 outputs, 5 BARI each.
    ...
    def test_22670(self):
        ...
        # that this bug is not detected because the transaction fee must be at least 0.01 BARI (the minimum change value).
        # Otherwise the targeted minimum change value will be enough to cover the transaction fees that were not
        # being accounted for. So the minimum relay fee is set to 0.1 BARI/kvB in this test.
    ...
    def test_feerate_rounding(self):
        ...
        # fail with insufficient funds rather than baricoind asserting.
