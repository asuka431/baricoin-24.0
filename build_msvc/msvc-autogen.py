#!/usr/bin/env python3
# Copyright (c) 2016-2021 The Baricoin Core developers
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Baricoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/baricoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/baricoin_config.h'), "w", encoding="utf8") as btc_config:
