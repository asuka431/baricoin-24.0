...
#ifndef BARICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BARICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BARICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
