...
public:
    ...
    void setDisplayUnit(BaricoinUnit unit)
    {
        bool valid = false;
        CAmount val = value(&valid);
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BaricoinUnits::format(BaricoinUnit::BARI, BaricoinUnits::maxMoney(), false, BaricoinUnits::SeparatorStyle::ALWAYS));
...
private:
    BaricoinUnit currentUnit{BaricoinUnit::BARI};
...
void BaricoinAmountField::unitChanged(int idx)
{
    ...
    QVariant new_unit = unit->currentData(BaricoinUnits::UnitRole);
    assert(new_unit.isValid());
    amount->setDisplayUnit(new_unit.value<BaricoinUnit>());
}

void BaricoinAmountField::setDisplayUnit(BaricoinUnit new_unit)
{
