...
void BaricoinGUI::createActions()
{
    ...
    connect(quitAction, &QAction::triggered, this, &BaricoinGUI::quitRequested);
    ...
    if(walletFrame)
    {
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &BaricoinGUI::setCurrentWallet, Qt::QueuedConnection);
...
void BaricoinGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &BaricoinGUI::toggleHidden);
...
void BaricoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void BaricoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    ...
    connect(dlg, &OptionsDialog::quitOnReset, this, &BaricoinGUI::quitRequested);
...
void BaricoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
#ifdef ENABLE_WALLET
void BaricoinGUI::incomingTransaction(const QString& date, BaricoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
      ...
      m_platform_style{platformStyle}
{
    ...
    QList<BaricoinUnit> units = BaricoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const BaricoinUnit unit : units) {
...
{
    menu = new QMenu(this);
    for (const BaricoinUnit u : BaricoinUnits::availableUnits()) {
        menu->addAction(BaricoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(BaricoinUnit newUnits)
{
