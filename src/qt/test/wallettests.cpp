...
{
    BaricoinUnit unit = walletModel.getOptionsModel()->getDisplayUnit();
    QString balanceComparison = BaricoinUnits::formatWithUnit(unit, expected_balance, false, BaricoinUnits::SeparatorStyle::ALWAYS);
